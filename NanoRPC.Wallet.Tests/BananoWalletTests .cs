...
{
  [TestClass]
  public class BananoWalletTests
  {
    ...
    private const string representative = "ban_1nano4cqttsbdo5nwttfse8h3oaxickjwq4qobqphg7hifbcauaokz9q6ugj";
    ...
    public async Task GetBalance()
    {
      ...
      Assert.AreEqual(new NanoAmount(0, AmountBase.Banano), result.Pending);
    }
